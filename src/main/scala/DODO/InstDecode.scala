...
class Decoder extends Module {
  ...
  io.isa.CSRRW := io.isa.RDCYCLE || io.isa.RDTIME // 通过RECYCLE和RETIME指令来识别CSR读写
  // CSR地址
  ...
  val src2 =(io.isa.Aclass() && ( io.isa.ADD || io.isa.SUB || io.isa.SLL || io.isa.SRL || io.isa.AND || io.isa.OR || io.isa.SLT || io.isa.SLTU || io.isa.XOR)) || io.isa.Bclass() || io.isa.Sclass() /* 识别需要rs2的指令 *///src2和src1并不都是存在的，因此我们需要使能信号来决定src是否有必要存在
